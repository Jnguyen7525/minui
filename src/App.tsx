      ...
      <div className="min-h-screen bg-black text-white overflow-y-scroll scrollbar-hide flex flex-col relative">
        ...
        "
          >
              ...
              <div className="flex flex-col h-full w-full space-y-5 items-center justify-center ">
                <Calendar
                  ...
                  classNames={{
                    ...
                    header:
                      "bg-black p-3 -m-3 mb-[0.5px] rounded-lg bg-gray-900",
            ...
            {/* toast */}
            <div className="p-10">
              <h1 className="text-xl font-bold">Toast Provider Example</h1>
              <ToastComponent />
              {/* Other app components go here */}
              <div className="space-y-3">
                <button
                  onClick={() => showToastMessage("Success!", "success")}
                  className="px-4 py-2 bg-green-500 text-white rounded"
                >
                  Show Success Toast
                </button>
                <button
                  onClick={() => showToastMessage("Error occurred!", "error")}
                  className="px-4 py-2 bg-red-500 text-white rounded"
                >
                  Show Error Toast
                </button>
                <button
                  onClick={() => showToastMessage("Warning!", "warning")}
