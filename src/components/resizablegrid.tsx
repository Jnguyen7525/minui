...
export function ResizableGridProvider({
  ...
  return (
    ...
    >
      <div
        ref={containerRef}
        className={`absolute grid gap-0 ${className}`}
        style={{
...
function GridCornerResizer({
  ...
  return (
    <div
      ...
      className={`absolute w-3 h-3 border z-20 ${cursorClass} ${positionClass}`}
    />
  );
}
...
export function GridPanel({
  ...
  return (
    <div
      ref={ref}
      className={`relative overflow-hidden border border-gray-300 ${className}`}
      style={{
...
function CornerResizer({
  ...
  return (
    <div
      onMouseDown={onMouseDown}
      className={`absolute w-3 h-3 border z-10 ${cursor} ${positionClass}`}
    />
  );
}
