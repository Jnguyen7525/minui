...
//   }, [isOpen, onToggle]); // ✅ Runs only when `isOpen` changes

//   return (
//     <div className="relative inline-block">
//       {/* Button */}
//       <button
//         className={`transition duration-150 ease-in-out ${buttonStyle}`}
//         onClick={() => onToggle(!isOpen)} // ✅ Correct toggle logic
//       >
//         {children}
//       </button>
...
//         <div
//           ref={popoverRef}
//           className={`absolute z-50 ${popoverStyle} transform transition duration-200 ${
//             placement === "top"
